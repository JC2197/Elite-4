    ...
    private void GetSwordSpriteDirection(){
        if(player.direction.y > 0){ //north..
            if(player.direction.x < 0){ //west
                ...
                transform.localPosition = new Vector3(-0.0209999997f,0.133f,0.5f);
                ...
                transform.localPosition = new Vector3(0.066f,0.133f,0.5f);
                ...
                transform.localPosition = new Vector3(0.0526000001f,0.133f,0.5f);
            ...
            if(player.direction.x < 0){ //west
                ...
                transform.localPosition = new Vector3(-0.0790000036f,0.133f,0.5f);
                ...
                transform.localPosition = new Vector3(-0.00200000009f,0.133f,-0.5f);
                ...
                transform.localPosition = new Vector3(-0.0480000004f, 0.133f,-0.5f);
